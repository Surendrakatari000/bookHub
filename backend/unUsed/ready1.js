[

  {
    ...
    aboutAuthor:
      "George Orwell was an English novelist, essayist, journalist, and critic whose workis marked by lucid prose, awareness of social injustice, and opposition to totalitarianism.",
    bookUrl:
  ...
  },
  {
    ...
    aboutBook:
      "A landmark popular science book on cosmology by physicist Stephen Hawking, exploringthe origins of the universe, space, time, black holes, and the search for a unified theory of physics.",
    aboutAuthor:
  ...
  },
  {
    ...
    aboutBook:
      "The story of Amir, a young boy from Kabul, and his journey toward redemption againstthe backdrop of a changing Afghanistan.",
    aboutAuthor:
  ...
  },
  {
    ...
    aboutBook:
      "A landmark magical realism novel telling the multi-generational story of the Buendíafamily in the fictional town of Macondo.",
    aboutAuthor:
  ...
  },
  {
    ...
    aboutAuthor:
      "Alexandre Dumas was a French novelist whose works have been translated into nearlya hundred languages and made into numerous films.",
    bookUrl:
  ...
  },
  {
    ...
    aboutBook:
      "A vast epic detailing the French invasion of Russia and the impact of the Napoleonicera on Tsarist society through the stories of five aristocratic families.",
    aboutAuthor:
      "Leo Tolstoy was a Russian writer widely regarded as one of the greatest authors ofall time.",
    bookUrl:
  ...
  },
  {
    ...
    aboutAuthor:
      "Fyodor Dostoevsky was a Russian novelist, philosopher, and essayist whose literaryworks explore human psychology in the turbulent political, social, and spiritual atmosphere of 19th-century Russia.",
    bookUrl:
  ...
  },
  {
    ...
    aboutBook:
      "A popular science book summarizing research that explains the two systems that drivethe way we think: System 1 is fast, intuitive, and emotional; System 2 is slower, more deliberative,and more logical.",
    aboutAuthor:
      "Daniel Kahneman was an Israeli-American psychologist and economist notable for hiswork on the psychology of judgment and decision-making.",
    bookUrl:
  ...
  },
  {
    ...
    aboutBook:
      "A leadership and productivity fable that emphasizes waking up early to optimize yourmornings, build personal mastery, and achieve peak performance.",
    aboutAuthor:
  ...
  },
  {
    ...
    aboutAuthor:
      "Héctor García and Francesc Miralles are authors who specialize in Japanese cultureand philosophy.",
    bookUrl:
